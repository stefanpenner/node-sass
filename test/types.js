...
describe('sass.types', function() {
  ...
  describe('Color', function() {
    ...
    it('supports variadic constructor args', function() {
      ...
      let c = new sass.types.Color(1, 2, 3);
      ...
      let d = new sass.types.Color(1, 2, 3, 4);
  ...
  describe('Error', function() {
    ...
    it('supports call constructor', function() {
      let e = sass.types.Error('Such Error');
    ...
    it('supports new constructor', function() {
      let e = new sass.types.Error('Such Error');
      assert.ok(e instanceof sass.types.Error);
      assert.equal(e.toString(), '[object SassError]');
      // TODO: I'm not sure this object works well, it likely needs to be fleshed out more...
    });
  ...
  describe('List', function() {
    ...
    it('supports {get,set}Separator', function() {
      ...
      [1, '', [], {}, new Map()].forEach(function(arg) {
        assert.throws(function() {
          a.setSeparator(arg);
        }, function(error) {
          assert.ok(error instanceof TypeError);
    ...
    it('supports setValue and getValue', function() {
      ...
      let omg = new sass.types.String('OMG');
      let b = new sass.types.List(1);
      b.setValue(0, omg);
      assert.equal(a.getValue(0), omg);
  ...
  describe('Map', function() {
    ...
    it('supports call constructor', function() {
      let x = sass.types.Map();
      assert.equal(x.toString(), '[object SassMap]');
    });

    it('supports new constructor', function() {
      let x = new sass.types.Map();
      assert.equal(x.toString(), '[object SassMap]');
    });

    it('supports an optional constructor argument', function() {
      let x = new sass.types.Map();
      let y = new sass.types.Map(1);
      let z = new sass.types.Map(2, 3);
    ...
    it('supports length', function() {
      // let x = new sass.types.Map(-1);
      let y = new sass.types.Map(1);
      let z = new sass.types.Map(2);
      // let a = new sass.types.Map(999999999999);

      // assert.equal(x.getLength(), -1);
      assert.equal(y.getLength(), 1);
      assert.equal(z.getLength(), 2);
    });
  ...
  describe('Number', function() {
    ...
    it('supports new constructor', function() {
      let number = new sass.types.Number();
    ...
    it('supports multiple constructor arguments', function() {
      let a = new sass.types.Number();
      let b = new sass.types.Number(1);
      let c = new sass.types.Number(2, 'px');
    ...
    it('supports get{Unit,Value}, set{Unit,Value}', function() {
      let number = new sass.types.Number(1, 'px');
  ...
  describe('String', function() {
    ...
    it('supports new constructor', function() {
      let x = new sass.types.String('OMG');
    ...
    it('supports multiple constructor arg combinations', function() {
      let x = new sass.types.String();
      let y = new sass.types.String('OMG');
      let z = new sass.types.String('OMG', 'NOPE');
